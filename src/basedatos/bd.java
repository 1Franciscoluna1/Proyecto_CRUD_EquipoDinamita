...
public class bd {
    Connection conexion;
    PreparedStatement insertArt, ultimo_id, cant_art, cons_art, total, cons_tkt, cons_rep, upd_cant;
    ...
    public bd(){
        ...
        cons_rep = conexion.prepareStatement("SELECT * FROM compras WHERE cod_art=?");
